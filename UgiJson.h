...
@property (nonatomic, retain) NSString *wrappedField;
...
@property char typeChar;
@property (nonatomic, retain) Class typeClass;
@property (nonatomic, retain) Class innerClass;
@property BOOL useSetForArray;
@property BOOL customSerialization;
@property BOOL customDeserialization;
...
static const NSString *UGI_CONTEXT_ROOT_OBJECT = @"rootObject";
static const NSString *UGI_CONTEXT_OBJECT_STACK = @"objectStack";
...
//
@optional
- (id) customSerialize:(NSString *)fieldName value:(id)value context:(NSMutableDictionary *)context;
...
//
@optional
- (id) customDeserialize:(NSString *)fieldName value:(id)value context:(NSMutableDictionary *)context;

//
// Handle a field in the JSON but not in the object
//
@optional
- (void) handleUnrecognizedField:(NSString *)key value:(NSObject *)value context:(NSMutableDictionary *)context;
...
//
// This field has custom serialization, call the customSerialize:value:context: method
//
#define UGI_FIELD_CUSTOM_SERIALIZATION(field) \
    @property BOOL _UgiJson_annotation_fieldž##field##žcustomSerialization

//
// This field has custom deserialization, call the customDeserialize:value:context: method
//
