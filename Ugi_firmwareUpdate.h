...
/**
 Callback type for checkForUpdateOnConnect
 @param info         Info for update that is ready (or nil if update cannot be loaded)
 @param required     YES if update is required
 */
typedef void (^AutomaticCheckForFirmwareUpdateCallback)(UgiFirmwareUpdateInfo *info, BOOL required);
...
/**
 ...
 @param callback  Completion code when an update is ready
 */
- (void) automaticCheckForFirmwareUpdate:(NSString *)channel
                    withCallback:(AutomaticCheckForFirmwareUpdateCallback)callback;
 ...
 */
- (void) forceFirmwareGrokkerCheck;
...
/**
 ...
 @param callback  Completion called after the update has been loaded
 */
...
/**
 ...
 @param callback  Completion code when updates are loaded
 */
- (void) loadUpdatesFromChannel:(NSString *)channel
                  withCallback:(void(^)(NSMutableArray *updates))callback;
...
/**
 See if the Internet is reachable
